...
fileToWrite = open(argv[1].strip(".txt") + "EnMetros.txt", "w") # file on which translations will be put
...
for line in fileToRead.readlines()[1:]:
    ...
    coordinates = [(2 * math.pi * r * float(i))/360 for i in coordinates] # translate: 2 * pi * radius * angle / 360
